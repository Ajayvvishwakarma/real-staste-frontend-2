...
const RequestACallIntegration = ({ isOpen, onClose }) => {
  const [form, setForm] = useState({
    name: "",
    email: "",
    phone: "",
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/50 backdrop-blur-sm px-2 sm:px-4">
      ...
      <div className="w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl bg-white/95 backdrop-blur-md rounded-xl shadow-2xl relative animate-fadeIn z-10">
        ...
        {/* Form */}
        <form
          className="px-4 sm:px-6 py-5 flex flex-col gap-4 text-sm sm:text-base"
        ...
        >
          ...
          <div>
            <textarea
              ...
              onChange={handleChange}
              placeholder="Enter your query"
              className={`border-b border-gray-300 focus:border-green-500 outline-none py-2 w-full resize-none ${
          ...
          {submitSuccess && (
            <div className="text-green-600 text-sm text-center bg-green-50 p-3 rounded">
              ✓ Callback request submitted successfully! We'll contact you
              within 24 hours.
            </div>
          )}
...
export default RequestACallIntegration;