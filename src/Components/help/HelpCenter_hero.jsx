...
const HelpCenterHeroIntegration = () => {
  return (
    <div className="w-full pb-10 bg-gray-100">
      {/* Hero Section */}
      <div className="w-full bg-gradient-to-r from-green-900 to-green-600 py-12 shadow-md">
        ...
        <div className="w-full flex flex-col md:flex-row justify-center items-center md:gap-15 gap-8 pt-20 px-4 md:px-0">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 flex-1 max-w-md flex flex-col items-center">
            ...
            <p className="text-gray-600 text-center mb-6">
              Question/Answers to Help You Find & Shortlist Your Perfect
              Property.
            </p>
            <Link
              to="/buyer-faq"
              className="bg-gradient-to-r from-green-600 to-black hover:from-black hover:to-green-600 text-white px-6 py-2 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center shadow-lg hover:shadow-xl transform hover:scale-105"
            >
              Know more
            </Link>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 flex-1 max-w-md flex flex-col items-center">
            ...
            <h2 className="text-xl font-semibold mb-2 text-center">Seller FAQ</h2>
            <p className="text-gray-600 text-center mb-6">
              Question/Answers to Help You Advertise Properties, Search Property
...
export default HelpCenterHeroIntegration;
