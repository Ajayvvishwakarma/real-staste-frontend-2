...
const HelpCenterNavbarIntegration = () => {
  const [showPopup, setShowPopup] = React.useState(false);
      ...
      <nav className="w-full navbar-animated-gradient shadow-lg backdrop-blur sticky top-0 z-50 transition-all duration-300">
        <div className="flex items-center justify-between px-4 sm:px-6 md:px-8 py-2">
          ...
          <div className="flex items-center gap-2 sm:gap-4 text-sm sm:text-base">
            <Link
              to="tel:+918929175327"
              className="text-white hover:text-yellow-300 font-semibold hover:underline flex items-center gap-2 transition-colors duration-200"
            >
              <svg
                width="20"
                height="20"
            ...
            <a
              href="mailto:help@bhoomitherealestate.com"
              className="text-white hover:text-yellow-300 font-semibold hover:underline transition-colors duration-200"
            >
              | Contact Us
            </a>
          </div>
...
export default HelpCenterNavbarIntegration;