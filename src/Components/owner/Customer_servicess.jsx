...
const CustomerServicesIntegration = ({ hideMainNavbar = false }) => {
  const navigate = useNavigate();
  const [searchTerm, setSearchTerm] = useState('');
  const [showCustomerService, setShowCustomerService] = useState(hideMainNavbar);
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false);
      ...
      {showCustomerService && (
        <div className="bg-gradient-to-r from-green-600 to-black text-white">
          <nav className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-6 xl:space-x-8 text-sm">
              <button onClick={() => setShowCustomerService(false)} className="hover:text-green-300 transition-all duration-300 cursor-pointer font-medium border-b-2 border-green-400 pb-1 transform hover:scale-105">
                CUSTOMER SERVICE
              </button>
              <button onClick={handlePostPropertyClick} className="hover:text-green-300 transition-all duration-300 cursor-pointer transform hover:scale-105">
                SELL / RENT PROPERTY
              </button>
              <button onClick={handleHomeLoansClick} className="hover:text-green-300 transition-all duration-300 cursor-pointer transform hover:scale-105">
                HOME LOANS
              </button>
              <div className="flex items-center space-x-1 hover:text-green-300 transition-all duration-300 cursor-pointer transform hover:scale-105">
                <FaGlobe className="w-4 h-4" />
                <span>EN</span>
              </div>
            </div>
            <button onClick={toggleMobileMenu} className="lg:hidden text-white hover:text-green-300 transition-colors">
              <FaBars className="w-6 h-6" />
            </button>
          </nav>
          {mobileMenuOpen && (
            <div className="lg:hidden bg-black bg-opacity-95 border-t border-green-600">
              <div className="max-w-7xl mx-auto px-4 py-4 space-y-4">
                <button onClick={() => setShowCustomerService(false)} className="block w-full text-left text-white hover:text-green-300 transition-colors py-2 border-b border-gray-700">
                  CUSTOMER SERVICE
                </button>
                <button onClick={handlePostPropertyClick} className="block w-full text-left text-white hover:text-green-300 transition-colors py-2 border-b border-gray-700">
                  SELL / RENT PROPERTY
                </button>
                <button onClick={handleHomeLoansClick} className="block w-full text-left text-white hover:text-green-300 transition-colors py-2 border-b border-gray-700">
                  HOME LOANS
                </button>
                <div className="flex items-center space-x-1 text-white hover:text-green-300 transition-colors py-2">
                  <FaGlobe className="w-4 h-4" />
          ...
          <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12 lg:py-16 text-center">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-normal mb-6 sm:mb-8">Hello, how can we help?</h2>
            <div className="relative max-w-2xl mx-auto">
              <input
                type="text"
                placeholder="Search by Keywords"
      ...
      {!showCustomerService && (
        <div className="bg-white shadow-lg border-b-4 border-green-600">
          <nav className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-6 xl:space-x-8 text-sm">
              <button onClick={() => setShowCustomerService(true)} className="text-black hover:text-green-600 transition-all duration-300 cursor-pointer font-medium transform hover:scale-105 px-3 py-2 rounded-lg hover:bg-green-50">
                CUSTOMER SERVICE & FAQ
              </button>
              <button onClick={handlePostPropertyClick} className="text-black hover:text-green-600 transition-all duration-300 cursor-pointer transform hover:scale-105 px-3 py-2 rounded-lg hover:bg-green-50">
                SELL / RENT PROPERTY
              </button>
              <button onClick={handleHomeLoansClick} className="text-black hover:text-green-600 transition-all duration-300 cursor-pointer transform hover:scale-105 px-3 py-2 rounded-lg hover:bg-green-50">
                HOME LOANS
              </button>
              <div className="flex items-center space-x-1 text-black hover:text-green-600 transition-all duration-300 cursor-pointer transform hover:scale-105 px-3 py-2 rounded-lg hover:bg-green-50">
                <FaGlobe className="w-4 h-4" />
            ...
            <button onClick={toggleMobileMenu} className="lg:hidden text-black hover:text-green-600 transition-colors">
              <FaBars className="w-6 h-6" />
            </button>
          </nav>
          {mobileMenuOpen && (
            <div className="lg:hidden bg-white border-t border-green-600 shadow-lg">
              <div className="max-w-7xl mx-auto px-4 py-4 space-y-4">
                <button onClick={() => setShowCustomerService(true)} className="block w-full text-left text-black hover:text-green-600 transition-colors py-2 border-b border-gray-200">
                  CUSTOMER SERVICE & FAQ
                </button>
                <button onClick={handlePostPropertyClick} className="block w-full text-left text-black hover:text-green-600 transition-colors py-2 border-b border-gray-200">
                  SELL / RENT PROPERTY
                </button>
                <button onClick={handleHomeLoansClick} className="block w-full text-left text-black hover:text-green-600 transition-colors py-2 border-b border-gray-200">
                  HOME LOANS
                </button>
                <div className="flex items-center space-x-1 text-black hover:text-green-600 transition-colors py-2">
                  <FaGlobe className="w-4 h-4" />
...
export default CustomerServicesIntegration;