...
// Inject custom slider styles (same as your original code)
const sliderStyles = `...`; // Use your full sliderStyles string here
if (typeof document !== 'undefined' && !document.getElementById('dealer-slider-styles')) {
  const style = document.createElement('style');
  style.textContent = sliderStyles;
  style.id = 'dealer-slider-styles';
  document.head.appendChild(style);
}
...
const DealerServicesIntegration = () => {
  const [openIndex, setOpenIndex] = useState(null);
    ...
    <section className="w-full bg-white py-10">
      ...
      <section className="bg-[#fff4e3] py-8 sm:py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 items-center">
          {/* FAQ Card */}
          <div className="bg-green-50 rounded-2xl shadow-md p-4 sm:p-6 lg:p-8 order-2 lg:order-1">
            <h4 className="text-xs sm:text-sm text-green-600 mb-2">Make a well informed decision</h4>
            <h2 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold text-black mb-4 sm:mb-6">
              Frequently Asked Questions
            </h2>
            <div className="space-y-3 sm:space-y-4">
...
export default DealerServicesIntegration;