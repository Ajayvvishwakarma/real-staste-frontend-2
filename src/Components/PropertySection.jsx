  ...
  useEffect(() => {
    const fetchArticles = async () => {
      ...
      try {
        ...
        setArticles([
          { id: 1, title: "How electricity bills impact cost of living?", date: "Sep 16, 2025", image: "/rent/image.png" },
          { id: 2, title: "GST cut on building materials: Experts", date: "Sep 04, 2025", image: "/rent/image1.png" },
          { id: 3, title: "What's Driving Siddharth Vihar Rates Up?", date: "Sep 12, 2025", image: "/rent/image2.png" },
          { id: 4, title: "Kolkata Tower Delay: Impact on Buyers", date: "Sep 02, 2025", image: "/rent/image3.png" },
          { id: 5, title: "Top Investment Tips for Property Owners", date: "Sep 10, 2025", image: "/rent/image4.png" },
          { id: 6, title: "Why Renting is Rising in Metro Cities", date: "Aug 29, 2025", image: "/rent/image copy.png" },
        ]);
      } finally {
        setLoading(false);
      }
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white shadow-xl w-full max-w-xs xs:max-w-sm sm:max-w-2xl md:max-w-4xl lg:max-w-4xl xl:max-w-4xl mx-auto border mt-[-60px] xs:mt-[-70px] sm:mt-[-80px] md:mt-[-80px] lg:mt-[-80px] xl:mt-[-80px] border-gray-100 rounded-xl sm:rounded-2xl overflow-hidden">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-2/3 p-3 xs:p-4 sm:p-6 md:p-8 lg:p-8 xl:p-8">
              {loading ? (
                <div className="text-center text-blue-600 py-10">Loading articles...</div>
              ) : (
                <div className="grid grid-cols-1 xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-3 xs:gap-4 sm:gap-6 md:gap-6 lg:gap-6 xl:gap-6">
                  {articles.slice(0, 4).map((article, idx) => (
                    <div
...
export default PropertySectionIntegration;