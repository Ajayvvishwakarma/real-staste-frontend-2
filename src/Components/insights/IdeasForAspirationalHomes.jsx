...
const IdeasForAspirationalHomesIntegration = () => {
  const sliderRef = useRef(null);
      ...
      <div className="relative">
        ...
        >
          {aspirationalIdeas.map((idea) => (
            <div
              key={idea.id}
              className="flex-shrink-0 w-[250px] sm:w-[280px] md:w-[calc((100%/4)-1rem)] bg-gradient-to-br from-blue-50 to-white rounded-xl shadow-xl hover:shadow-2xl transition-shadow cursor-pointer snap-start hover:scale-105 duration-300"
            >
              <div className="relative">
                <img
                  src={idea.image}
...
export default IdeasForAspirationalHomesIntegration;