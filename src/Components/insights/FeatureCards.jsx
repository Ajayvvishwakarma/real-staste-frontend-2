        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-4 gap-3 px-8">
            {cards.map((card) => (
              <div
                key={card.id}
                className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-3 text-center group cursor-pointer"
              >
                <div
                  className={`w-12 h-12 ${card.bgColor} rounded-full flex items-center justify-center mx-auto mb-2 ${card.hoverColor} transition-colors duration-200`}
                >
                  {card.icon}
                </div>
                <h3 className="font-semibold text-gray-800 text-sm mb-1">{card.title}</h3>
        ...
        <div className="relative">
          ...
          >
            {cards.map((card) => (
              <div
                key={card.id}
                className="flex-shrink-0 w-32 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-3 text-center group cursor-pointer"
              >
                <div
                  className={`w-10 h-10 ${card.bgColor} rounded-full flex items-center justify-center mx-auto mb-2 ${card.hoverColor} transition-colors duration-200`}
                >
                  {card.icon}
                </div>
                <h3 className="font-semibold text-gray-800 text-xs mb-1">{card.title}</h3>
...
export default FeatureCardsIntegration;