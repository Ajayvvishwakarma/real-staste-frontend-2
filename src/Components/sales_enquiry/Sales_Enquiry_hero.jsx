...
import React from "react";
import SalesEnquiryNavbarIntegration from "./Sales_enguiry_Navbar";

const SalesEnquiryHeroIntegration = () => {
  return (
    <>
      <SalesEnquiryNavbarIntegration />
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-12">
        {/* Breadcrumb */}
        <div className="text-xs sm:text-sm text-gray-500 mb-3">
          <span className="text-green-700 font-medium cursor-pointer">Home</span> &gt; <span>Contact us</span>
...
export default SalesEnquiryHeroIntegration;