...
const BuyerGuideIntegration = () => {
  ...
  const guideData = [
    // Use the guideData array from your original code.
  ];

  const trendingData = [
    // Use the trendingData array from your original code.
  ];

  const newsData = [
    // Use the newsData array from your original code.
  ];
  ...
  const totalNewsPages = Math.ceil(newsData.length / newsPerPage);
  ...
  const handlePrevNews = () => setNewsPage(prev => (prev > 0 ? prev - 1 : totalNewsPages - 1));
  const handleNextNews = () => setNewsPage(prev => (prev < totalNewsPages - 1 ? prev + 1 : 0));
  ...
  return (
    <div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="text-center mb-4 sm:mb-6">
            <div className="flex flex-col sm:flex-row justify-center items-center mb-3 space-y-2 sm:space-y-0">
              ...
              <div className="sm:ml-4">
                <h1 className="text-2xl sm:text-2xl lg:text-3xl font-semibold mb-1 bg-gradient-to-r from-white to-green-200 bg-clip-text text-transparent">
                  BUYER GUIDE
                </h1>
              </div>
            </div>
      ...
      {/* ...use your original content to render the trending and news sections here... */}
    </div>
  );
};
