...
const FeaturedServiceProviderIntegration = () => {
  const providers = [
    {
      name: "Ramakrishna Associates",
      location: "TRI NAGAR, DELHI",
        ...
        <div className="w-full max-w-7xl">
          <div className="grid grid-rows-3 grid-cols-4 gap-6">
            {providers.map((provider, idx) => (
              <div
                key={idx}
                className="bg-white rounded-xl shadow-lg p-3 flex flex-col min-h-[140px] transition-all duration-200 hover:shadow-2xl hover:-translate-y-1"
              >
                <div className="flex items-center gap-4 mb-2">
                  {provider.logo ? (
                    <img
                  ...
                  <div>
                    <div className="font-semibold text-lg truncate max-w-[180px]">
                      {provider.name}
                    </div>
                ...
                <div className="flex gap-6 mb-2">
                  <div className="text-sm font-semibold text-gray-700">
                    {provider.sale} <span className="font-normal">Sale</span>
                    <br />
                    Properties
                  </div>
                  {provider.rent && (
                    <div className="text-sm font-semibold text-gray-700">
                      {provider.rent} <span className="font-normal">Rent</span>
                      <br />
                      Properties
                    </div>
                  )}
...
export default FeaturedServiceProviderIntegration;